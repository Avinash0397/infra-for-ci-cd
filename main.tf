module "vpc" {
  source     = "./modules/vpc"
  vpc_name   = "avinash-vpc"
  cidr_block = "10.11.0.0/16"

}
module "public_subnet_01" {
  source            = "./modules/public_subnet"
  subnet_name       = "avinash-public-subnet"
...
module "public_subnet_02" {
  source            = "./modules/public_subnet"
  subnet_name       = "avinash-public-subnet-2"
...
module "private_subnet_01" {
  ...
  private_subnet_name = "avinash-private-subnet"
